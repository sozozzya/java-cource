...
public class ConsoleMenuFactory implements AbstractMenuFactory {
    ...
    public Menu createRootMenu() {
        ...
        Menu bookingsCsvMenu = new Menu("CSV operations", List.of(
                new MenuItem("Import bookings from CSV", new ImportBookingsAction(admin), null),
                new MenuItem("Export bookings to CSV", new ExportBookingsAction(admin), null),
                new MenuItem("Back", new BackAction())
        ));
        ...
        Menu bookingsMenu = new Menu(MenuTitles.BOOKINGS.get(), List.of(
                ...
                new MenuItem("CSV import/export", new NavigateAction(bookingsCsvMenu), bookingsCsvMenu),
        ...
        Menu roomsCsvMenu = new Menu("CSV operations", List.of(
                new MenuItem("Import rooms from CSV", new ImportRoomsAction(admin), null),
                new MenuItem("Export rooms to CSV", new ExportRoomsAction(admin), null),
                new MenuItem("Back", new BackAction())
        ));
        ...
        Menu servicesCsvMenu = new Menu("CSV operations", List.of(
                new MenuItem("Import services from CSV", new ImportServicesAction(admin), null),
                new MenuItem("Export services to CSV", new ExportServicesAction(admin), null),
                new MenuItem("Back", new BackAction())
        ));
        ...
        Menu servicesMenu = new Menu(MenuTitles.SERVICES.get(), List.of(
                ...
                new MenuItem("CSV import/export", new NavigateAction(servicesCsvMenu), servicesCsvMenu),
                new MenuItem("Back to main", new BackAction())
        ));
        ...
        Menu guestsCsvMenu = new Menu("CSV operations", List.of(
                new MenuItem("Import guests from CSV", new ImportGuestsAction(admin), null),
                new MenuItem("Export guests to CSV", new ExportGuestsAction(admin), null),
                new MenuItem("Back", new BackAction())
        ));

        Menu guestsMenu = new Menu(MenuTitles.GUESTS.get(), List.of(
                new MenuItem("Add guest", new AddGuestAction(admin), null),
                ...
                new MenuItem("CSV import/export", new NavigateAction(guestsCsvMenu), guestsCsvMenu),
                new MenuItem("Back to main", new BackAction())
        ));
