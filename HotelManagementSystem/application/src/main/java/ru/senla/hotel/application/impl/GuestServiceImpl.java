...
import ru.senla.hotel.application.exception.guest.GuestAlreadyExistsException;
...
public class GuestServiceImpl implements GuestService {
    ...
    public List<Guest> getAllGuests() {
        ...
        try {
            ...
            log.error("Failed to fetch guests", e);
            throw new GuestException("Failed to fetch guests", e);
        }
    }
