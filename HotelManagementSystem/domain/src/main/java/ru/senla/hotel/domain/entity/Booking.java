...
public class Booking implements Identifiable, Serializable {
    ...
    public List<BookingFavor> getServices() {
    ...
    public void addService(Favor service, LocalDate date) {
        if (service == null) return;
        services.add(new BookingFavor(this, service, date));
    }
