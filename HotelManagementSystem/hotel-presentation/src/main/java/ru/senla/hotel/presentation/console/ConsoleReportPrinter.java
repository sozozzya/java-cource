package ru.senla.hotel.presentation.console;
...
public class ConsoleReportPrinter {
    ...
    private static final Logger log = LoggerFactory.getLogger(ConsoleReportPrinter.class);
    ...
    public ConsoleReportPrinter(BookingManager bookingManager,
